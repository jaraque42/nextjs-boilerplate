...
export default function WhatsAppButton() {
  ...
  const message = encodeURIComponent("Hola Juan, me gustaría consultarte sobre un proyecto web.")
  ...
  return (
    <div className="fixed bottom-6 left-6 z-50 flex gap-4">
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-tr from-[#f9ce34] via-[#ee2a7b] to-[#6228d7] text-white shadow-lg transition-transform hover:scale-110 active:scale-95"
