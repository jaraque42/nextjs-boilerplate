              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-2">
                  <a
                    ...
                    className="flex items-center gap-1 rounded-full bg-[#25D366]/10 px-2 py-1 text-[10px] font-bold text-[#25D366] transition hover:bg-[#25D366]/20"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-1 rounded-full bg-[#E4405F]/10 px-2 py-1 text-[10px] font-bold text-[#E4405F] transition hover:bg-[#E4405F]/20"
                  >
                    <svg viewBox="0 0 24 24" width="14" height="14" fill="currentColor">
